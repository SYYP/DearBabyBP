...
public class Class_OtherAdapter extends BaseAdapter {
    ...
    public Class_OtherAdapter(Context context, List<String> channelList, boolean isUser) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = LayoutInflater.from(context).inflate(R.layout.mygridview_item, null);
